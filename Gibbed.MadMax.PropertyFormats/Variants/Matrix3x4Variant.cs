...
namespace Gibbed.MadMax.PropertyFormats.Variants
{
    ...
    public class Matrix3x4Variant : IVariant, RawPropertyContainerFile.IRawVariant, PropertyContainerFile.IRawVariant
        // ReSharper restore InconsistentNaming
    {
        private FileFormats.Matrix3x4 _Value;

        public FileFormats.Matrix3x4 Value
        {
        ...
        public void Parse(string text)
        {
            ...
            this._Value = new FileFormats.Matrix3x4(m11, m12, m13, m21, m22, m23, m31, m32, m33, m41, m42, m43);
        }
        ...
        {
            FileFormats.Matrix3x4.Write(output, this._Value, endian);
        }

        void RawPropertyContainerFile.IRawVariant.Deserialize(Stream input, Endian endian)
        {
            this._Value = FileFormats.Matrix3x4.Read(input, endian);
        }
        #endregion
